...
var RulesEngine = /** @class */ (function () {
    function RulesEngine(actionTopic) {
        ...
        this.engine = new json_rules_engine_1.Engine([], {
            ...
            return _this.handleRuleSuccess(event, almanac, ruleResult, _this.actionTopic);
        })
            .on('failure', function (event, almanac, ruleResult) {
            return _this.handleRuleFailure(event, almanac, ruleResult, _this.actionTopic);
        });
    }
    ...
    RulesEngine.prototype.handleRuleFailure = function (event, almanac, ruleResult, actionTopic) {
        log('failed rule ' + JSON.stringify(ruleResult));
    };
    RulesEngine.prototype.handleRuleSuccess = function (event, almanac, ruleResult, actionTopic) {
