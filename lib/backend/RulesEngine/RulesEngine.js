...
var RulesEngine = /** @class */ (function () {
    function RulesEngine(actionTopic) {
        ...
        this.engine = new json_rules_engine_1.Engine([], {
            ...
            .on('success', function (event, almanac, ruleResult) { return handleRuleSuccess(event, almanac, ruleResult, _this.actionTopic); });
    }
...
function handleRuleSuccess(event, almanac, ruleResult, actionTopic) {
    ...
    if (timeframe_1.doesTimeframeMatchRule(timestamp, timeframe)) {
        ...
        events_1.processEvent(event, entities, actionTopic);
    }
}
