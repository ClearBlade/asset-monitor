...
function handleRuleSuccess(event, almanac, ruleResult, actionTopic) {
    ...
    if (timeframe_1.doesTimeframeMatchRule(incomingData.timestamp, timeframe)) {
        var triggers = getTriggerIds(ruleResult.conditions.all
        ...
        events_1.processEvent(event, entities, actionTopic, incomingData);
    }
}
                    ...
                    new Promise(function (res) {
                        ...
                        var promise = collection
                            ...
                            for (var i = 0; i < data.DATA.length; i++) {
                                ...
                                //@ts-ignore
                                log('we only have the one ' + JSON.stringify(withParsedCustomData));
