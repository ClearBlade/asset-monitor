...
var RulesEngine = /** @class */ (function () {
    function RulesEngine() {
        ...
        this.engine = new json_rules_engine_1.Engine([], options)
            ...
            handleStateRule(params, almanac);
        })
    ...
    RulesEngine.prototype.run = function (facts) {
        return __awaiter(this, void 0, void 0, function () {
            var promise;
            return __generator(this, function (_a) {
                promise = this.engine.run(facts).then(function () { return 'ENGINE SUCCESSFULLY COMPLETED'; }).catch(function (e) { return "ENGINE ERROR: " + JSON.stringify(e); });
                Promise.runQueue();
                return [2 /*return*/, promise];
            });
        });
...
function handleStateRule(params, almanac) {
    var promise = almanac.factValue('incomingData').then(function (incomingData) {
        var promise = almanac.factValue(params.id).then(function (customData) { return customData; }).catch(function () {
            return new Promise(function (res) {
                ...
                var promise = collection.cbFetchPromise({ query: query }).then(function (data) {
                    ...
                    for (var i = 0; i < data.DATA.length; i++) {
                        ...
                        almanac.addRuntimeFact(entityData.id, withParsedCustomData); // add fact for id
                    }
