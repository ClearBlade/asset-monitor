        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                promise = this.engine.run(fact)
                    .then(function (results) { return "SUCCESSFUL RULES: " + results.events.map(function (e) { return e.type; }).join(', '); })
...
function handleStateCondition(params, almanac) {
    var promise = almanac.factValue('incomingData').then(function (incomingData) {
        var promise = almanac.factValue(params.id).then(function (customData) {
            if (!!customData) {
                return customData;
            }
            ;
