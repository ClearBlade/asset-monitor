...
function processRuleResults(events, facts, timestamp) {
    if (events.length > 0) {
        for (var i = 0; i < events.length; i++) {
            ...
            if (params.timeframe === undefined || timeframe_1.DoesTimeframeMatchRule(timestamp, params.timeframe)) {
...
var RulesEngine = /** @class */ (function () {
    ...
    RulesEngine.prototype.convertRule = function (ruleData) {
        return __awaiter(this, void 0, void 0, function () {
            var name, conditions, timeframe, actionIDs, rule, ruleInfo, promise;
            return __generator(this, function (_a) {
                ...
                promise = convert_rule_1.ParseAndConvertConditions(ruleInfo, rule.conditions, conditions).then(function (convertedConditions) {
