...
function filterByIdAndDuration(processedRule, triggerId) {
    return processedRule.reduce(function (filteredRule, combination) {
        ...
        if (hasId) {
            if (allTrue && !hasDuration) {
                ...
                filteredRule.pendingDurations.push(combination);
            }
        }
        return filteredRule;
    }, {
...
function filterProcessedRule(processedRule, triggerId, topLevelType) {
    var filteredProcessed = filterByIdAndDuration(processedRule, triggerId);
