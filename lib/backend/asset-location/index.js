...
var defaultOptions = {
    ...
    LOG_SERVICE_NAME: global_config_1.GC.UPDATE_ASSET_LOCATION_OPTIONS.LOG_SERVICE_NAME,
};
function updateAssetLocationSS(_a) {
    var req = _a.req, resp = _a.resp, _b = _a.options, _c = _b === void 0 ? defaultOptions : _b, _d = _c.KEYS_TO_UPDATE, KEYS_TO_UPDATE = _d === void 0 ? defaultOptions.KEYS_TO_UPDATE : _d, _e = _c.LOG_SETTING, LOG_SETTING = _e === void 0 ? defaultOptions.LOG_SETTING : _e, _f = _c.LOG_SERVICE_NAME, LOG_SERVICE_NAME = _f === void 0 ? defaultOptions.LOG_SERVICE_NAME : _f, _g = _c.CREATE_NEW_ASSET_IF_MISSING, CREATE_NEW_ASSET_IF_MISSING = _g === void 0 ? defaultOptions.CREATE_NEW_ASSET_IF_MISSING : _g;
    ...
    function successCb(value) {
        logger.publishLog(global_config_1.LogLevels.INFO, 'Succeeded ', value);
    }
        ...
        assetsCol
            ...
            if (data.DATA.length === 1) {
                ...
                if (CREATE_NEW_ASSET_IF_MISSING) {
                    createAsset_1.default(assetID, incomingMsg, logger).then(successCb, failureCb);
