...
function createAssetHistorySS(_a) {
    var req = _a.req, resp = _a.resp, _b = _a.options, _c = _b === void 0 ? defaultOptions : _b, _d = _c.STANDARD_KEYS_TO_STORE, STANDARD_KEYS_TO_STORE = _d === void 0 ? defaultOptions.STANDARD_KEYS_TO_STORE : _d, _e = _c.CUSTOM_DATA_KEYS_TO_STORE, CUSTOM_DATA_KEYS_TO_STORE = _e === void 0 ? defaultOptions.CUSTOM_DATA_KEYS_TO_STORE : _e, _f = _c.LOG_SETTING, LOG_SETTING = _f === void 0 ? defaultOptions.LOG_SETTING : _f, _g = _c.CUSTOM_DATA_KEY_STORAGE_SETTING, CUSTOM_DATA_KEY_STORAGE_SETTING = _g === void 0 ? defaultOptions.CUSTOM_DATA_KEY_STORAGE_SETTING : _g, _h = _c.STANDARD_KEY_STORAGE_SETTING, STANDARD_KEY_STORAGE_SETTING = _h === void 0 ? defaultOptions.STANDARD_KEY_STORAGE_SETTING : _h;
    ...
    var logger = new Logger_1.Logger({ name: 'AssetHistorySSLib', logSetting: LOG_SETTING });
    ...
    function WaitLoop() {
        logger.publishLog(global_config_1.LogLevels.SUCCESS, 'Subscribed to Shared Topics. Starting Loop.');
