...
*/
function publishExternalEvent(asset, ruleId, ruleTopicFn) {
    if (ruleTopicFn === void 0) { ruleTopicFn = Util_1.Topics.RulesAssetLocation; }
    ClearBlade.Messaging().publish(ruleTopicFn(asset.id), JSON.stringify(__assign(__assign({}, asset), { meta: { rule_id: ruleId, is_external_rule_type: true } })));
}
